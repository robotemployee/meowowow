# miauw
hello. this is something i made forrrrrr engineering and whatever. it's just a template project you can use to have nice intellisense suggestions for the xrp robot circuit board things.

i'm pretty sure the code is perfectly compatible with what you can write in the web editor - the XRPLib thing we have here is directly taken from the board lol. 
...
**if you don't know what any of that means, don't worry. it's just a copy and pasting w a few clicks in between, tutorials below**
